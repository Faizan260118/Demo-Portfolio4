...
function scrollUp() {
    ...
    // When the scroll is higher than 560 viewport height, add the show-scroll class to the a tag with the scroll anchor tag
...
if (selectedTheme) {
    // if the validateis fulfilled, we ask what the issue was to know if we activated or deactivated the dark theme
